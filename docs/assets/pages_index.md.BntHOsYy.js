...
<span class="line"><span>├── .env.production             # custom domain base path 설정</span></span>
<span class="line"><span>└── package.json</span></span></code></pre></div><h2 id="_2-각-앱에-config-설정-base-경로-지정" tabindex="-1">2. 각 앱에 config 설정 (base 경로 지정) <a class="header-anchor" href="#_2-각-앱에-config-설정-base-경로-지정" aria-label="Permalink to &quot;2. 각 앱에 config 설정 (base 경로 지정)&quot;">​</a></h2><ul><li>각 앱의 config.ts 또는 config.js에 base 경로를 지정해야 합니다.</li><li>예: apps/app1/vite.config.ts</li></ul><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { defineConfig, loadEnv } from &#39;vite&#39;</span></span>
...
<span class="line"><span>    const rootDir = resolve(__dirname, &#39;../../&#39;)</span></span>
<span class="line"><span>    const env = loadEnv(mode, rootDir)</span></span>
<span class="line"><span>    return {</span></span>
<span class="line"><span>        plugins: [vue()],</span></span>
<span class="line"><span>        base: env.VITE_BASE_APPNAME,</span></span>
<span class="line"><span>        //.env는 git domain에서 사용할 경로 관리 - &#39;/&lt;repositoryName&gt;/app1/&#39;</span></span>
<span class="line"><span>        //.env.production는 custom domain에서 사용할 경로 관리 : &#39;/app1/&#39;</span></span>
<span class="line"><span>    }</span></span>
